...
class _CurrentlyPlayingState extends State<CurrentlyPlaying>
{
  ...
  {
    http.Response response = await http.post(link, body: {"trackId" : "3dhjNA0jGA8vHBQ1VdD6vV"});
        ...
        children: <Widget>[
          ...
          Column(
            ...
            children: <Widget>[
              ...
              _imageURLValue != null ? Image.network(_imageURLValue, height: 300) : Container(child: Text('no picture'),),

              Row(mainAxisSize: MainAxisSize.max, children: <Widget>[Padding(padding: EdgeInsets.only(left: 30.0)), Text('${_songName}', style: TextStyle(fontSize: 25, color: Colors.amber)),
